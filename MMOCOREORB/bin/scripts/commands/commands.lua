...
RunSlashCommandsFile("unarmedBleed.lua")
...
RunSlashCommandsFile("creatureAreaBurn.lua")
RunSlashCommandsFile("droidOverclock.lua")
RunSlashCommandsFile("stayFocused.lua")
RunSlashCommandsFile("commandersForce.lua")
RunSlashCommandsFile("droidPhaserOverclock.lua")
RunSlashCommandsFile("droidReboot.lua")
RunSlashCommandsFile("dizzyShot.lua")
RunSlashCommandsFile("barrageShot.lua")
RunSlashCommandsFile("punishingShot.lua")
RunSlashCommandsFile("lethalExertion.lua")
RunSlashCommandsFile("buffetingOnslaught.lua")
RunSlashCommandsFile("ruthlessSurge.lua")
RunSlashCommandsFile("destructiveOvercharge.lua")
RunSlashCommandsFile("commandosGambit.lua")
RunSlashCommandsFile("engulfingFlame.lua")
RunSlashCommandsFile("hastyGetaway.lua")
RunSlashCommandsFile("burgeoningWallop.lua")
RunSlashCommandsFile("unyieldingBatter.lua")
RunSlashCommandsFile("mercilessSlash.lua")
RunSlashCommandsFile("wbossAreaCombo.lua")
RunSlashCommandsFile("wbossAreaKnockdown.lua")
RunSlashCommandsFile("wbossAreaAttack.lua")
RunSlashCommandsFile("unarmedMaelstrom.lua")
RunSlashCommandsFile("fullAutoAssault.lua")
RunSlashCommandsFile("crownShot.lua")
RunSlashCommandsFile("disablingShot.lua")
RunSlashCommandsFile("outragePets.lua")
RunSlashCommandsFile("encouragePets.lua")
RunSlashCommandsFile("dazingShock.lua")
RunSlashCommandsFile("cripplingSurge.lua")
RunSlashCommandsFile("debilitatingJolt.lua")
RunSlashCommandsFile("carbineBash.lua")
RunSlashCommandsFile("focusedFire.lua")
RunSlashCommandsFile("rapidBombardment.lua")
RunSlashCommandsFile("singleBurn.lua")
RunSlashCommandsFile("mindBurn.lua")
RunSlashCommandsFile("wbossAreaMindBash.lua")
RunSlashCommandsFile("wbossAreaTremor.lua")
--RunSlashCommandsFile("fireCannons.lua")
--RunSlashCommandsFile("takeCommand.lua")
