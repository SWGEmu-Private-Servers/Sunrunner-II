...
object_draft_schematic_armor_armor_segment_padded_advanced = object_draft_schematic_armor_shared_armor_segment_padded_advanced:new {
	...
	ingredientTitleNames = {"segment_layer_assembly_plate", "armor_layer_weld_tabs", "segment_mounting_tabs", "armor_layer_blast", "armor_layer_kinetic", "segment_enhancement"},
	ingredientSlotType = {0, 0, 0, 3, 3, 3},
	resourceTypes = {"hide_wooly_yavin4", "steel_cubirian", "steel_duralloy", "object/tangible/component/armor/shared_armor_layer_blast.iff", "object/tangible/component/armor/shared_armor_layer_kinetic.iff", "object/tangible/component/armor/shared_base_armor_segment_enhancement_padded.iff"},
