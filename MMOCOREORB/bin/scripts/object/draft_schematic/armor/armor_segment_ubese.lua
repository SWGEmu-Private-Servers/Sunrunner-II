...
object_draft_schematic_armor_armor_segment_ubese = object_draft_schematic_armor_shared_armor_segment_ubese:new {
	...
	resourceTypes = {"iron", "steel", "fiberplast", "object/tangible/component/armor/shared_armor_layer_energy.iff", "object/tangible/component/armor/shared_base_armor_segment_enhancement_ubese.iff"},
