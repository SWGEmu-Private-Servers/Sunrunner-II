...
bountyhuntermaster = { {"firelightningcone1",""},{"firelightningcone2",""},{"firelightningsingle1",""},{"firelightningsingle2",""},{"bleedingshot",""},{"underhandshot",""},{"eyeshot",""},{"knockdownfire",""},{"torsoshot",""},{"confusionshot",""},{"fastblast",""},{"sprayshot",""},{"dazingshock",""},{"cripplingsurge",""},{"debilitatingjolt",""},{"unarmedbleed",""} }
commandomaster = { {"flamecone1",""},{"flamecone2",""},{"flamesingle1",""},{"flamesingle2",""},{"fireacidcone1",""},{"fireacidcone2",""},{"fireacidsingle1",""},{"fireacidsingle2",""},{"engulfingflame",""},{"lethalexertion",""},{"buffetingonslaught",""},{"ruthlesssurge",""},{"rapidbombardment",""} }
carbineermaster = { {"actionshot2",""},{"fullautosingle2",""},{"fullautoarea2",""},{"wildshot2",""},{"scattershot2",""},{"legshot3",""},{"cripplingshot",""},{"burstshot2",""},{"suppressionfire2",""},{"chargeshot2",""},{"fullautoassault",""} }
pistoleermaster = { {"healthshot2",""},{"pointblanksingle2",""},{"bodyshot3",""},{"pistolmeleedefense2",""},{"disarmingshot2",""},{"doubletap",""},{"stoppingshot",""},{"fanshot",""},{"pointblankarea2",""},{"multitargetpistolshot",""},{"crownshot",""} }
riflemanmaster = { {"headshot3",""},{"strafeshot2",""},{"mindshot2",""},{"flushingshot2",""},{"startleshot2",""},{"flurryshot2",""},{"disablingshot",""} }
fencermaster = { {"melee1hhit3",""},{"melee1hscatterhit2",""},{"melee1hdizzyhit2",""},{"melee1hhealthhit2",""},{"melee1hspinattack2",""},{"melee1hbodyhit2",""},{"melee1hblindhit2",""},{"mercilessslash",""} }
swordsmanmaster = { {"melee2hhit3",""},{"melee2harea3",""},{"melee2hspinattack2",""},{"melee2hsweep2",""},{"melee2hmindhit2",""},{"melee2hheadhit3",""},{"burgeoningwallop",""} }
pikemanmaster = { {"polearmactionhit2",""},{"polearmarea2",""},{"polearmhit3",""},{"polearmleghit3",""},{"polearmspinattack2",""},{"polearmstun2",""},{"polearmsweep2",""},{"unyieldingbatter",""} }
tkamaster = { {"unarmedhit3",""},{"unarmedleghit1",""},{"unarmedbodyhit1",""},{"unarmedheadhit1",""},{"unarmedspinattack2",""},{"unarmedcombo2",""},{"unarmedknockdown2",""},{"unarmeddizzy1",""},{"unarmedmaelstrom",""} }
...
affliction = { {"creatureareaburn",""},{"creatureareadisease",""},{"creatureareapoison",""} }
...
igdroidpet = { {"headshot3",""},{"commandersforce",""},{"mindshot2",""},{"focusedfire",""},{"barrageshot",""},{"flurryshot2",""},{"overchargeshot2",""},{"dizzyshot",""} }

magnadroidpet = { {"polearmactionhit2",""},{"polearmarea2",""},{"polearmhit2",""},{"polearmleghit3",""},{"polearmspinattack2",""},{"polearmstun2",""},{"unyieldingbatter",""} }

battledroidpet = { {"actionshot2",""},{"fullautosingle2",""},{"fullautoarea2",""},{"wildshot2",""},{"scattershot2",""},{"legshot3",""},{"cripplingshot",""},{"burstshot2",""},{"overchargeshot2",""},{"focusedfire",""},{"fullautoassault",""} }

droidekapet = { {"commandersforce",""},{"lastditch",""},{"fullautoarea2",""},{"wildshot2",""},{"eyeshot",""},{"legshot3",""},{"cripplingshot",""},{"burstshot2",""},{"stoppingshot",""},{"focusedfire",""},{"fullautoassault",""} }

superbattledroidpet = { {"healthshot2",""},{"pointblanksingle2",""},{"bodyshot3",""},{"torsoshot",""},{"focusedfire",""},{"doubletap",""},{"stoppingshot",""},{"commandersforce",""},{"fanshot",""},{"pointblankarea2",""},{"multitargetpistolshot",""},{"crownshot",""} }

toxify = { {"strongpoison",""} }

corrode = { {"creatureareapoison",""} }

infect = { {"strongdisease",""} }

contaminate = { {"creatureareadisease",""} }

singe = { {"singleburn",""} }

engulf = { {"creatureareaburn",""} }

curse = { {"creatureareacombo",""} }

rend = { {"creatureareableeding",""} }

terrorize = { {"mindburn",""} }

robodogpet = { {"creatureareableeding",""},{"stunattack",""},{"dizzyattack",""},{"creatureareacombo",""},{"blindattack",""} }