...
function NabooTheedScreenPlay:spawnMobiles()
	...
	--new newbie spawns
	spawnMobile(self.planet, "gungan_hermit", 360, -5977.4, 9.6, 3875.2, -117, 0)
	spawnMobile(self.planet, "ankura_gungan", 360, -5977.1, 9.2, 3882.4, 151, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -5988.3, 8.5, 3889.9, -33, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -5971.6, 9.8, 3871.8, -2, 0)
	spawnMobile(self.planet, "ankura_gungan", 360, -5974.2, 9, 3885.7, 61, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -6083.7, 8.9, 3837.8, -90, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -6091.3, 8.9, 3840.5, 124, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -6096.5, 9.1, 3837.9, -41, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -6103.9, 9, 3842.3, 89, 0)
	spawnMobile(self.planet, "ankura_gungan", 360, -6101.6, 9.6, 3830.4, 15, 0)
	spawnMobile(self.planet, "ankura_gungan", 360, -6089.7, 9.5, 3827.1, 129, 0)
	spawnMobile(self.planet, "ankura_gungan", 360, -6083.7, 8.4, 3850, 94, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -6095.3, 8.6, 3849, -20, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -5919, 7.2, 3937.8, 62, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -5927.9, 6.9, 3939.9, -135, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -5930.4, 6.5, 3949.1, -26, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -5913.6, 7.1, 3946.9, -134, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -5916.5, 6.8, 3955.6, -152, 0)
	spawnMobile(self.planet, "ankura_gungan", 360, -5922.4, 6.7, 3948.4, -40, 0)
	spawnMobile(self.planet, "gungan_hermit", 360, -5989.1, 9, 3876.5, 62, 0)
	spawnMobile(self.planet, "explorer", 420, -5750.6, 13.2, 3710.3, 87, 0)
	spawnMobile(self.planet, "explorer", 420, -5747.2, 13.2, 3712.1, -120, 0)
	spawnMobile(self.planet, "explorer", 420, -5747.5, 13.2, 3717.4, 135, 0)
	spawnMobile(self.planet, "explorer", 420, -4760.3, 6, 3579.8, -90, 0)
	spawnMobile(self.planet, "explorer", 420, -4757.2, 6, 3586.2, -120, 0)
	spawnMobile(self.planet, "explorer", 420, -4753.7, 6, 3575.4, 7, 0)
	spawnMobile(self.planet, "explorer", 420, -4761.1, 6, 3586.8, 157, 0)
	spawnMobile(self.planet, "explorer", 420, -4766.3, 6, 3581.3, 81, 0)
	spawnMobile(self.planet, "thug", 360, -4926.6, -196.3, 4717.7, -46, 0)
	spawnMobile(self.planet, "thug", 360, -4929.5, -196.3, 4724, -34, 0)
	spawnMobile(self.planet, "thug", 360, -4930.6, -196.3, 4714.3, -112, 0)
	spawnMobile(self.planet, "thug", 360, -4936.4, -196.3, 4709, 121, 0)
	spawnMobile(self.planet, "thug", 360, -4946.4, -196.3, 4704.1, 3, 0)
	spawnMobile(self.planet, "thug", 360, -4934.3, -196.3, 4731.9, -120, 0)
	spawnMobile(self.planet, "thug", 360, -4944.9, -196.3, 4736.5, 31, 0)
	spawnMobile(self.planet, "thug", 360, -4935.5, -196.3, 4703, 0, 0)
	spawnMobile(self.planet, "thug", 360, -4931, -196.3, 4720.3, -96, 0)
	spawnMobile(self.planet, "thug", 360, -6054.3, -196, 4748.4, -115, 0)
	spawnMobile(self.planet, "thug", 360, -6057.5, -196, 4747.1, 66, 0)
	spawnMobile(self.planet, "thug", 360, -6065.7, -196, 4740.7, -68, 0)
	spawnMobile(self.planet, "thug", 360, -6069, -196, 4742.7, 123, 0)
	spawnMobile(self.planet, "thug", 360, -6084.4, -196, 4740.6, -141, 0)
	spawnMobile(self.planet, "thug", 360, -6086.3, -196, 4753.9, -15, 0)
	spawnMobile(self.planet, "thug", 360, -6065.6, -196, 4727.5, 154, 0)
	spawnMobile(self.planet, "thug", 360, -6056.8, -196, 4729, 116, 0)
	spawnMobile(self.planet, "thug", 360, -6043.8, -196, 4743.7, 102, 0)
	spawnMobile(self.planet, "thug", 360, -6041.6, -196, 4753.3, 26, 0)
