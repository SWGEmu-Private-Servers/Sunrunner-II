...
baseStoredCreaturePets = 45
baseStoredFactionPets = 12
baseStoredDroids = 15
...
veteranRewardAdditionalMilestones = 90 --frequency, in days, of additional milestones (beyond the established ones)
...
veteranRewards = {
		...
		{templateFile = "object/tangible/veteran_reward/frn_vet_holo_sandcrawler.iff", milestone=90, oneTime=false, description="Sandcrawler Hologram"},
		...
		{templateFile = "object/tangible/veteran_reward/frn_vet_holo_lambda.iff", milestone=180, oneTime=false, description="Lambda Shuttle Hologram"},
		{templateFile = "object/tangible/veteran_reward/frn_vet_holo_starfighter.iff", milestone=180, oneTime=false, description="Starfighter Hologram"},
		...
		{templateFile = "object/tangible/veteran_reward/frn_vet_holo_imperial_guard.iff", milestone=270, oneTime=false, description="Imperial Guard Hologram"},
		{templateFile = "object/tangible/veteran_reward/frn_vet_rug_imperial.iff", milestone=270, oneTime=false, description="Imperial Rug"},
		{templateFile = "object/tangible/veteran_reward/frn_vet_rug_rebel.iff", milestone=270, oneTime=false, description="Rebel Rug"},
		...
		{templateFile = "object/tangible/veteran_reward/frn_vet_holo_luke_skywalker.iff", milestone=360, oneTime=false, description="Luke Skywalker Hologram"},
		{templateFile = "object/tangible/veteran_reward/frn_vet_holo_leia.iff", milestone=360, oneTime=false, description="Leia Organa Hologram"},
		{templateFile = "object/tangible/veteran_reward/frn_vet_display_stand.iff", milestone=360, oneTime=false, description="Display Stand"},
		...
		{templateFile = "object/tangible/veteran_reward/frn_vet_holo_darth_vader.iff", milestone=450, oneTime=false, description="Darth Vader Hologram"},
		{templateFile = "object/tangible/furniture/ep3_rewards/hologram_yt1300_01.iff", milestone=450, oneTime=false, description="YT-1300 Hologram"},
		...
		{templateFile = "object/tangible/furniture/ep3_rewards/hologram_stardestroyer_01.iff", milestone=540, oneTime=false, description="Star Destroyer Hologram"},
		...
		{templateFile = "object/tangible/veteran_reward/frn_vet_holo_deathstar.iff", milestone=630, oneTime=false, description="Death Star Hologram"},
		...
		{templateFile = "object/tangible/veteran_reward/frn_vet_holo_yoda.iff", milestone=720, oneTime=false, description="Yoda Hologram"},
		...
		{templateFile = "object/tangible/veteran_reward/darth_maul_statue.iff", milestone=810, oneTime=false, description="Darth Maul Statue"},
		...
		{templateFile = "object/tangible/veteran_reward/frn_vet_emp_chair.iff", milestone=900, oneTime=true, description="Emperor's Throne"},
		...
		{templateFile = "object/tangible/tcg/series8/decorative_palpatine_hologram.iff", milestone=990, oneTime=false, description="Palpatine Hologram"},
		...
		{templateFile = "object/tangible/veteran_reward/frn_galactic_gathering_2008_painting.iff", milestone=1080, oneTime=false, description="Painting: Galactic Gathering 2008"},
		{templateFile = "object/tangible/veteran_reward/frn_vet_5_year_painting.iff", milestone=1080, oneTime=false, description="Painting: 5th Anniversary"},
		{templateFile = "object/tangible/veteran_reward/frn_vet_6_year_painting.iff", milestone=1080, oneTime=false, description="Painting: 6th Anniversary"},
		{templateFile = "object/tangible/veteran_reward/yr7_painting_2010.iff", milestone=1080, oneTime=false, description="Painting: 7th Anniversary"},
