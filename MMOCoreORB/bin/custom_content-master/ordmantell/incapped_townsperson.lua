incapped_townsperson = Creature:new {
	customName = "an incapacitated townsperson",
...
CreatureTemplates:addCreatureTemplate(incapped_townsperson, "incapped_townsperson")