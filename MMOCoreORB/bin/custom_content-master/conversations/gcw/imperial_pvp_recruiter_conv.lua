imperialPvPRecruiterConvoTemplate = ConvoTemplate:new {
	initialScreen = "",
	templateType = "Lua",
...
imperialPvPRecruiterConvoTemplate:addScreen(greet_hated);
...
imperialPvPRecruiterConvoTemplate:addScreen(greet_changing_status);
...
imperialPvPRecruiterConvoTemplate:addScreen(greet_enemy);
...
imperialPvPRecruiterConvoTemplate:addScreen(member_covert_start);
...
imperialPvPRecruiterConvoTemplate:addScreen(member_overt_start);
...
imperialPvPRecruiterConvoTemplate:addScreen(neutral_start);
...
imperialPvPRecruiterConvoTemplate:addScreen(onleave_start);
...
imperialPvPRecruiterConvoTemplate:addScreen(join_military);
...
imperialPvPRecruiterConvoTemplate:addScreen(neutral_need_more_points);
...
imperialPvPRecruiterConvoTemplate:addScreen(accept_join);
...
imperialPvPRecruiterConvoTemplate:addScreen(think_more);
...
imperialPvPRecruiterConvoTemplate:addScreen(confirm_go_overt);
...
imperialPvPRecruiterConvoTemplate:addScreen(confirm_go_covert);
...
imperialPvPRecruiterConvoTemplate:addScreen(stay_special_forces);
...
imperialPvPRecruiterConvoTemplate:addScreen(accepted_go_overt);
...
imperialPvPRecruiterConvoTemplate:addScreen(accepted_go_covert);
...
imperialPvPRecruiterConvoTemplate:addScreen(leave_time_covert);
...
imperialPvPRecruiterConvoTemplate:addScreen(stay_covert);
...
imperialPvPRecruiterConvoTemplate:addScreen(leave_time_overt);
...
imperialPvPRecruiterConvoTemplate:addScreen(stay_overt);
...
imperialPvPRecruiterConvoTemplate:addScreen(accepted_go_on_leave);
...
imperialPvPRecruiterConvoTemplate:addScreen(leave_resign_covert);
...
imperialPvPRecruiterConvoTemplate:addScreen(dont_resign_covert);
...
imperialPvPRecruiterConvoTemplate:addScreen(leave_resign_overt);
...
imperialPvPRecruiterConvoTemplate:addScreen(dont_resign_overt);
...
imperialPvPRecruiterConvoTemplate:addScreen(accepted_resign);
...
imperialPvPRecruiterConvoTemplate:addScreen(resume_duties);
...
imperialPvPRecruiterConvoTemplate:addScreen(stay_on_leave);
...
imperialPvPRecruiterConvoTemplate:addScreen(accepted_resume_duties);
...
imperialPvPRecruiterConvoTemplate:addScreen(confirm_promotion);
...
imperialPvPRecruiterConvoTemplate:addScreen(accepted_promotion);
...
imperialPvPRecruiterConvoTemplate:addScreen(declined_promotion);
...
imperialPvPRecruiterConvoTemplate:addScreen(not_enough_points);
...
imperialPvPRecruiterConvoTemplate:addScreen(confirm_bribe);
...
imperialPvPRecruiterConvoTemplate:addScreen(accepted_bribe_20k);
...
imperialPvPRecruiterConvoTemplate:addScreen(accepted_bribe_100k);
...
imperialPvPRecruiterConvoTemplate:addScreen(faction_purchase);
...
imperialPvPRecruiterConvoTemplate:addScreen(fp_uniforms);
...
imperialPvPRecruiterConvoTemplate:addScreen(fp_furniture);
...
imperialPvPRecruiterConvoTemplate:addScreen(fp_weapons_armor);
...
imperialPvPRecruiterConvoTemplate:addScreen(fp_installations);
...
imperialPvPRecruiterConvoTemplate:addScreen(fp_schematics);
...
imperialPvPRecruiterConvoTemplate:addScreen(fp_hirelings);
...
imperialPvPRecruiterConvoTemplate:addScreen(show_gcw_score);

addConversationTemplate("imperialPvPRecruiterConvoTemplate", imperialPvPRecruiterConvoTemplate);
