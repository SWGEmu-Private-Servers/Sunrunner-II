rebelnabooPvPrecruiterConvoTemplate = ConvoTemplate:new {
	initialScreen = "",
	templateType = "Lua",
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(greet_hated);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(greet_changing_status);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(greet_enemy);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(member_covert_start);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(member_overt_start);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(neutral_start);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(onleave_start);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(join_military);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(neutral_need_more_points);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(accept_join);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(think_more);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(confirm_go_overt);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(confirm_go_covert);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(stay_special_forces);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(accepted_go_overt);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(accepted_go_covert);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(leave_time_covert);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(stay_covert);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(leave_time_overt);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(stay_overt);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(accepted_go_on_leave);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(leave_resign_covert);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(dont_resign_covert);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(leave_resign_overt);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(dont_resign_overt);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(accepted_resign);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(resume_duties);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(stay_on_leave);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(accepted_resume_duties);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(confirm_promotion);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(accepted_promotion);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(declined_promotion);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(not_enough_points);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(confirm_bribe);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(accepted_bribe_20k);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(accepted_bribe_100k);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(faction_purchase);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(fp_furniture);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(fp_weapons_armor);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(fp_installations);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(fp_schematics);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(fp_hirelings);
...
rebelnabooPvPrecruiterConvoTemplate:addScreen(show_gcw_score);

addConversationTemplate("rebelnabooPvPrecruiterConvoTemplate", rebelnabooPvPrecruiterConvoTemplate);
