rebelhothPvPRecruiterConvoTemplate = ConvoTemplate:new {
	initialScreen = "",
	templateType = "Lua",
...
rebelhothPvPRecruiterConvoTemplate:addScreen(greet_hated);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(greet_changing_status);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(greet_enemy);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(member_covert_start);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(member_overt_start);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(neutral_start);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(onleave_start);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(join_military);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(neutral_need_more_points);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(accept_join);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(think_more);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(confirm_go_overt);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(confirm_go_covert);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(stay_special_forces);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(accepted_go_overt);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(accepted_go_covert);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(leave_time_covert);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(stay_covert);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(leave_time_overt);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(stay_overt);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(accepted_go_on_leave);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(leave_resign_covert);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(dont_resign_covert);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(leave_resign_overt);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(dont_resign_overt);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(accepted_resign);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(resume_duties);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(stay_on_leave);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(accepted_resume_duties);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(confirm_promotion);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(accepted_promotion);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(declined_promotion);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(not_enough_points);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(confirm_bribe);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(accepted_bribe_20k);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(accepted_bribe_100k);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(faction_purchase);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(fp_furniture);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(fp_weapons_armor);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(fp_installations);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(fp_schematics);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(fp_hirelings);
...
rebelhothPvPRecruiterConvoTemplate:addScreen(show_gcw_score);

addConversationTemplate("rebelhothPvPRecruiterConvoTemplate", rebelhothPvPRecruiterConvoTemplate);
