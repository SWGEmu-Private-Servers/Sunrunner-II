cloudcityfred_template = ConvoTemplate:new {
	initialScreen = "first_screen",
	templateType = "Lua",
	luaClassHandler = "cloudcityfred_convo_handler",
	screens = {}
}
...
cloudcityfred_template:addScreen(first_screen);
--------------------------------------------------------------------------------------------
...
cloudcityfred_template:addScreen(accept_quest);
--------------------------------------------------------------------------------------------
...
cloudcityfred_template:addScreen(check);
--------------------------------------------------------------------------------------------
...
cloudcityfred_template:addScreen(not_yet);
--------------------------------------------------------------------------------------------
...
cloudcityfred_template:addScreen(wrong_docs);
--------------------------------------------------------------------------------------------
...
cloudcityfred_template:addScreen(wrong_docs);
--------------------------------------------------------------------------------------------
addConversationTemplate("cloudcityfred_template", cloudcityfred_template);
