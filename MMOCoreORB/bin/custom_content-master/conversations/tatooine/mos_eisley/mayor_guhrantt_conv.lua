...
mayor_guhrantt_convo_template:addScreen(anything_else);
...
wild_vermin = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/mos_eisley_mayor:s_164", "accept_task_entha"}, -- I'll help her.
...
accept_task_entha = ConvoScreen:new {
	id = "accept_task_entha",
	leftDialog = "@conversation/mos_eisley_mayor:s_165", -- Good.
	stopConversation = "true",
	options = {}
}
mayor_guhrantt_convo_template:addScreen(accept_task_entha);
