...
--]]
------------------------------------------------------------
as_inf02_npc01 = Creature:new {
	customName = "Nufs Cheheit (Master Armorsmith)",
	...
	lootGroups = {},
	weapons = {},
	conversationTemplate = "as_inf02_npc01_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(as_inf02_npc01, "as_inf02_npc01")
