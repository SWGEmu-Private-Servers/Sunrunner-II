...
arch_schem01_npc02 = Creature:new {
	customName = "Local Architect",
	...
	outfit = "",
	conversationTemplate = "arch_schem01_npc02_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(arch_schem01_npc02, "arch_schem01_npc02")
