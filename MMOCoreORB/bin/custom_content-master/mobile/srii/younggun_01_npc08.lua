...
younggun_01_npc08 = Creature:new {
	customName = "Research Scientist",
	...
	conversationTemplate = "younggun_01_npc08_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_01_npc08, "younggun_01_npc08")
