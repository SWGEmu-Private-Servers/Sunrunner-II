...
younggun_pq01_npc01 = Creature:new {
	customName = "Entrite Phalixa (a well known outlaw)",
	...
	outfit = "younggun_pq01_npc01_outfit",
	conversationTemplate = "younggun_pq01_npc01_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_pq01_npc01, "younggun_pq01_npc01")
