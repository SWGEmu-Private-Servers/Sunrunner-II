...
younggun_01_npc04 = Creature:new {
	customName = "Wes Travor (Information Broker)",
	...
	outfit = "",
	conversationTemplate = "younggun_01_npc04_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_01_npc04, "younggun_01_npc04")
