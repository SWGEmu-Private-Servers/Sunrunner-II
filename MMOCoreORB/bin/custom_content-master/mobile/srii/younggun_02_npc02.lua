...
younggun_02_npc02 = Creature:new {
	customName = "Convict (Hutt Smuggler)",
	...
	conversationTemplate = "younggun_02_npc02_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_02_npc02, "younggun_02_npc02")
