...
younggun_01_npc11 = Creature:new {
	customName = "Eik Raimi (Gambler)",
	...
	outfit = "",
	conversationTemplate = "younggun_01_npc11_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_01_npc11, "younggun_01_npc11")
