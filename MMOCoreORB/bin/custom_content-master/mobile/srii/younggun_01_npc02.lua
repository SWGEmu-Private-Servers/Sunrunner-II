...
younggun_01_npc02 = Creature:new {
	customName = "Local Informant (for hire)",
	socialGroup = "nym",
	faction = "nym",
	faction = "",
	level = 100,
	...
	outfit = "",
	conversationTemplate = "younggun_01_npc02_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_01_npc02, "younggun_01_npc02")
