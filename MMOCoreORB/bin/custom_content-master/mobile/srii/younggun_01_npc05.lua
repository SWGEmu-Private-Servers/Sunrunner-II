...
younggun_01_npc05 = Creature:new {
	...
	outfit = "",
	conversationTemplate = "younggun_01_npc05_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_01_npc05, "younggun_01_npc05")
