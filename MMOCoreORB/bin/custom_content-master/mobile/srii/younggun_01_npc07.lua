...
younggun_01_npc07 = Creature:new {
	customName = "Research Assistant",
	...
	outfit = "",
	conversationTemplate = "younggun_01_npc07_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_01_npc07, "younggun_01_npc07")
