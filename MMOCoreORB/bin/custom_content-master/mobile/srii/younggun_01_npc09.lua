...
younggun_01_npc09 = Creature:new {
	...
	outfit = "",
	conversationTemplate = "younggun_01_npc09_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_01_npc09, "younggun_01_npc09")
