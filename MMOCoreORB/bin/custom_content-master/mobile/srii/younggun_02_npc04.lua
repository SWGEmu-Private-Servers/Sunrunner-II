...
younggun_02_npc04 = Creature:new {
	customName = "Faywa Tooluha (Galactic Entertainer)",
	socialGroup = "hutt",
	faction = "hutt",
	level = 100,
	chanceHit = 0.64,
	...
	lootGroups = {},
	weapons = {},
	conversationTemplate = "younggun_02_npc04_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_02_npc04, "younggun_02_npc04")
