...
younggun_01_npc03 = Creature:new {
	customName = "Eritha Summiick",
	...
	outfit = "",
	conversationTemplate = "younggun_01_npc03_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_01_npc03, "younggun_01_npc03")
