...
arch_schem03_npc01 = Creature:new {
	customName = "Ze Brotha (Architect Master)",
	...
	conversationTemplate = "arch_schem03_npc01_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(arch_schem03_npc01, "arch_schem03_npc01")
