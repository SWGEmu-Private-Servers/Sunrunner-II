...
younggun_01_npc10 = Creature:new {
	customName = "Traelo Veepir (Spice Expert)",
	...
	outfit = "",
	conversationTemplate = "younggun_01_npc10_convo_template",
	attacks = {
	}
}

CreatureTemplates:addCreatureTemplate(younggun_01_npc10, "younggun_01_npc10")
