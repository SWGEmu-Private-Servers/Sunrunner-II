rebel_tatooine_gcw_vendor = Creature:new {
	--customName = "an Alliance GCW Quartermaster",
	objectName = "@mob/creature_names:alliance_tatooine_gcw_vendor",
	...
	conversationTemplate = "rebeltatooinePvPRecruiterConvoTemplate",
...
CreatureTemplates:addCreatureTemplate(rebel_tatooine_gcw_vendor, "rebel_tatooine_gcw_vendor")
