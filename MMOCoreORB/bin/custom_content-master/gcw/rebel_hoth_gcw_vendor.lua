rebel_hoth_gcw_vendor = Creature:new {
	--customName = "an Alliance GCW Quartermaster",
	objectName = "@mob/creature_names:alliance_hoth_gcw_vendor",
	...
	conversationTemplate = "rebelhothPvPRecruiterConvoTemplate",
...
CreatureTemplates:addCreatureTemplate(rebel_hoth_gcw_vendor, "rebel_hoth_gcw_vendor")
