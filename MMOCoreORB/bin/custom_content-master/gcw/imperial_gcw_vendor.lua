imperial_gcw_vendor = Creature:new {
	--customName = "an Imperial GCW Quartermaster",
	objectName = "@mob/creature_names:imperial_corellia_gcw_vendor",
	...
	conversationTemplate = "imperialPvPRecruiterConvoTemplate",
	reactionStf = "@npc_reaction/military",
	personalityStf = "@hireling/hireling_military",
	attacks = merge(brawlermaster,marksmanmaster)
}

CreatureTemplates:addCreatureTemplate(imperial_gcw_vendor, "imperial_gcw_vendor")
