rebel_gcw_vendor = Creature:new {
	--customName = "an Alliance GCW Quartermaster",
	objectName = "@mob/creature_names:alliance_corellia_gcw_vendor",
	...
	conversationTemplate = "rebelPvPRecruiterConvoTemplate",
...
CreatureTemplates:addCreatureTemplate(rebel_gcw_vendor, "rebel_gcw_vendor")
