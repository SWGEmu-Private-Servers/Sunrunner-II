...
object_building_heroic_echo_base = object_building_heroic_shared_echo_base:new {
	...
	--childObjects = {
	--	{templateFile = "object/tangible/terminal/terminal_cloning.iff", x = 71.4, z = -14.65, y = 275.8, ox = 0, oy = 0.707106, oz = 0, ow = 0.707106, cellid = 28, containmentType = -1},
	--	{templateFile = "object/tangible/terminal/terminal_insurance.iff", x = 69.7, z = -14.7, y = 293.6, ox = 0, oy = 0.707106, oz = 0, ow = 0.707106, cellid = 28, containmentType = -1},        	
	--},
