object_building_player_barn_house = object_building_player_shared_barn_house:new {
	lotSize = 2,
	baseMaintenanceRate = 10,
	allowedZones = {"corellia", "dantooine", "lok", "naboo", "rori", "talus", "tatooine", "taanab", "nalhutta"},
	publicStructure = 0,
	length = 1,
	width = 1,
	skillMods = {
...
ObjectTemplates:addTemplate(object_building_player_barn_house, "object/building/player/barn_house.iff")
