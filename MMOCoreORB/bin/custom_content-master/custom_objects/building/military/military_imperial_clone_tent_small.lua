object_building_military_military_imperial_clone_tent_small = object_building_military_shared_military_imperial_clone_tent_small:new {
	...
	childCreatureObjects = {
		{ mobile = "imperial_recruiter", x = 0, z = 0, y = 4, cellid = -1, containmentType = -1, respawn = 60, heading = 3.14},
	},
...
ObjectTemplates:addTemplate(object_building_military_military_imperial_clone_tent_small, "object/building/military/military_imperial_clone_tent_small.iff")
