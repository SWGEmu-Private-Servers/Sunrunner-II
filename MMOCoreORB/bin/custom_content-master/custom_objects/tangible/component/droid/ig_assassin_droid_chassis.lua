object_tangible_component_droid_ig_assassin_droid_chassis = object_tangible_component_droid_shared_ig_assassin_droid_chassis:new {
...
ObjectTemplates:addTemplate(object_tangible_component_droid_ig_assassin_droid_chassis, "object/tangible/component/droid/ig_assassin_droid_chassis.iff")
