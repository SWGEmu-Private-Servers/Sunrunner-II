...
object_tangible_wearables_armor_invisible_invisible_helmet_rebel = object_tangible_wearables_armor_invisible_shared_invisible_helmet:new {
	templateType = ARMOROBJECT,

	customName = "Invisible Rebel GCW Armor Helmet",
	faction = "Rebel",
	--noTrade = 1,
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_invisible_invisible_helmet_rebel, "object/tangible/wearables/armor/invisible/invisible_helmet_rebel.iff")
