object_tangible_deed_player_house_deed_barn_house_deed = object_tangible_deed_player_house_deed_shared_barn_house_deed:new {
	...
	generatedObjectTemplate = "object/building/player/barn_house.iff",
...
ObjectTemplates:addTemplate(object_tangible_deed_player_house_deed_barn_house_deed, "object/tangible/deed/player_house_deed/barn_house_deed.iff")
