...
object_draft_schematic_bio_engineer_creature_creature_pharple = object_draft_schematic_bio_engineer_creature_shared_creature_pharple:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Pharple",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/pharple_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_pharple, "object/draft_schematic/bio_engineer/creature/creature_pharple.iff")
