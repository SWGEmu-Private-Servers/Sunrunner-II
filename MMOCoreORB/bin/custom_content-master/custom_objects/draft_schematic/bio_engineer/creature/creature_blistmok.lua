...
object_draft_schematic_bio_engineer_creature_creature_blistmok = object_draft_schematic_bio_engineer_creature_shared_creature_blistmok:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Blistmok",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/blistmok_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_blistmok, "object/draft_schematic/bio_engineer/creature/creature_blistmok.iff")
