...
object_draft_schematic_bio_engineer_creature_creature_urnsoris = object_draft_schematic_bio_engineer_creature_shared_creature_urnsoris:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Urnsoris",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/urnsoris_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_urnsoris, "object/draft_schematic/bio_engineer/creature/creature_urnsoris.iff")
