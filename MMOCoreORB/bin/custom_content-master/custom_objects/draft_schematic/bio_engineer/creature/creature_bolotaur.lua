...
object_draft_schematic_bio_engineer_creature_creature_bolotaur = object_draft_schematic_bio_engineer_creature_shared_creature_bolotaur:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Bolotaur",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/bolotaur_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_bolotaur, "object/draft_schematic/bio_engineer/creature/creature_bolotaur.iff")
