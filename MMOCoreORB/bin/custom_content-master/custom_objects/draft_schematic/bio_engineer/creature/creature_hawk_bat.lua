...
object_draft_schematic_bio_engineer_creature_creature_hawk_bat = object_draft_schematic_bio_engineer_creature_shared_creature_hawk_bat:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Hawk Bat",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/hawk_bat_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_hawk_bat, "object/draft_schematic/bio_engineer/creature/creature_hawk_bat.iff")
