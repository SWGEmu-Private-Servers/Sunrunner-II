...
object_draft_schematic_bio_engineer_creature_creature_walluga = object_draft_schematic_bio_engineer_creature_shared_creature_walluga:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Walluga",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/walluga_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_walluga, "object/draft_schematic/bio_engineer/creature/creature_walluga.iff")
