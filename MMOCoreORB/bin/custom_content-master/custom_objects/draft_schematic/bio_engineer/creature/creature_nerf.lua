...
object_draft_schematic_bio_engineer_creature_creature_nerf = object_draft_schematic_bio_engineer_creature_shared_creature_nerf:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Nerf",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/nerf_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_nerf, "object/draft_schematic/bio_engineer/creature/creature_nerf.iff")
