...
object_draft_schematic_bio_engineer_creature_creature_kashyyyk_bantha = object_draft_schematic_bio_engineer_creature_shared_creature_kashyyyk_bantha:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Kashyyyk Bantha",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/kashyyyk_bantha_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_kashyyyk_bantha, "object/draft_schematic/bio_engineer/creature/creature_kashyyyk_bantha.iff")
