...
object_draft_schematic_furniture_bespin_lamp_on = object_draft_schematic_furniture_shared_bespin_lamp_on:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Bespin Lamp",
...
ObjectTemplates:addTemplate(object_draft_schematic_furniture_bespin_lamp_on, "object/draft_schematic/furniture/bespin_lamp_on.iff")
