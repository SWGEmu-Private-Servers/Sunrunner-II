object_draft_schematic_droid_component_chassis_droid_ig_assassin = object_draft_schematic_droid_component_shared_chassis_droid_ig_assassin:new {
	templateType = DRAFTSCHEMATIC,

	customObjectName = "IG Assassin Droid Chassis",
	...
	resourceQuantities = {240, 80, 100, 1, 1, 1, 1, 1},
	contribution = {100, 100, 100, 100, 100, 100, 100, 100},

	targetTemplate = "object/tangible/component/droid/ig_assassin_droid_chassis.iff",

	additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_droid_component_chassis_droid_ig_assassin, "object/draft_schematic/droid/component/chassis_droid_ig_assassin.iff")
