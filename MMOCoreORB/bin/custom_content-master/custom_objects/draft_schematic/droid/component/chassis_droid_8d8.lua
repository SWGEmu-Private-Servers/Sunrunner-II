object_draft_schematic_droid_component_chassis_droid_8d8 = object_draft_schematic_droid_component_shared_chassis_droid_8d8:new {
	...
	customObjectName = "8D8 Droid Chassis",
