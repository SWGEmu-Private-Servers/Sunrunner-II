object_draft_schematic_weapon_pistol_deathhammer_needle = object_draft_schematic_weapon_shared_pistol_deathhammer_needle:new {
   ...
   resourceTypes = {"aluminum", "steel", "chemical", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/component/weapon/shared_blaster_pistol_barrel.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
   resourceQuantities = {85, 48, 28, 1, 1, 1},
