object_draft_schematic_weapon_lance_cryo = object_draft_schematic_weapon_shared_lance_cryo:new {
   ...
   customObjectName = "Cryo Lance Schematic",
   ...
   resourceTypes = {"metal", "mineral", "chemical", "object/tangible/component/weapon/shared_vibro_unit.iff", "steel_duralloy"},
   resourceQuantities = {85, 38, 38, 3, 15},
