object_draft_schematic_armor_armor_appearance_neutral_clone_bicep_l = object_draft_schematic_armor_shared_armor_appearance_neutral_clone_bicep_l:new {
 templateType = DRAFTSCHEMATIC,

   customObjectName = "Neutral Clone Trooper Armor Left Bicep",
   ...
   resourceQuantities = {150, 100, 85, 70, 60, 40, 4, 1, 1},
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_neutral_clone_bicep_l, "object/draft_schematic/armor/armor_appearance_neutral_clone_bicep_l.iff")
