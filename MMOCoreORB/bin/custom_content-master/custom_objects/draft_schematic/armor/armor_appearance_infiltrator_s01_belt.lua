...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_infiltrator_s01_belt, "object/draft_schematic/armor/armor_appearance_infiltrator_s01_belt.iff")
