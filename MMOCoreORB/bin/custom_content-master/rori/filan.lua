filan = Creature:new {
	...
	templates = {
		"object/mobile/dressed_rebel_restuss_commando_leader.iff"
	},
	...
	lootGroups = {
		{
			groups = {
				...
				{group = "g_errant_bracelet_r", chance = 1500000}
			},
			lootchance = 10000000
		}
	},
...
CreatureTemplates:addCreatureTemplate(filan, "filan")