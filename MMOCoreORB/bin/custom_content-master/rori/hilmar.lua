hilmar = Creature:new {
	...
	templates = {
		"object/mobile/dressed_restuss_captain_exov.iff"
	},
	...
	lootGroups = {
		{
			groups = {
				...
				{group = "g_officer_bracelet_l", chance = 1500000}
			},
			lootchance = 10000000
		}
	},
...
CreatureTemplates:addCreatureTemplate(hilmar, "hilmar")