ekarn = Creature:new {
	customName = "Sergeant Major Ekarn",
	...
	templates = {
		"object/mobile/dressed_restuss_captain_okto.iff"
	},
	...
	lootGroups = {
		{
			groups = {
				...
				{group = "g_sergeant_bracelet_l", chance = 1500000}
			},
			lootchance = 10000000
		}
	},
...
CreatureTemplates:addCreatureTemplate(ekarn, "ekarn")
