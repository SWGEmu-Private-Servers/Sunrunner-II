myorak = Creature:new {
	...
	templates = {
		"object/mobile/dressed_rebel_restuss_captain_redding.iff"
	},
	...
	lootGroups = {
		{
			groups = {
				...
				{group = "g_stout_bracelet_r", chance = 1500000}
			},
			lootchance = 10000000
		}
	},
...
CreatureTemplates:addCreatureTemplate(myorak, "myorak")