jallen = Creature:new {
	...
	templates = {
		"object/mobile/dressed_restuss_rebel_lt_olvog.iff"
	},
	...
	lootGroups = {
		{
			groups = {
				...
				{group = "g_veteran_bracelet_r", chance = 1500000}
			},
			lootchance = 10000000
		}
	},
...
CreatureTemplates:addCreatureTemplate(jallen, "jallen")