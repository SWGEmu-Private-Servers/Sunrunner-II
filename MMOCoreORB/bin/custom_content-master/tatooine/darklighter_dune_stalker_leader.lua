darklighter_dune_stalker_leader = Creature:new {
	customName = "a Dune Stalker leader",
	...
	lootGroups = {
		{
			groups = {
				...
				{group = "g_clothing_assem_bracelet_r", chance = 1000000},
...
CreatureTemplates:addCreatureTemplate(darklighter_dune_stalker_leader, "darklighter_dune_stalker_leader")
