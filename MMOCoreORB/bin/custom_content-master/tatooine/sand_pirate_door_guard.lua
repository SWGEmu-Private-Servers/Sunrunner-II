sand_pirate_door_guard = Creature:new {
	customName = "a Sand Pirate door guard",
...
CreatureTemplates:addCreatureTemplate(sand_pirate_door_guard, "sand_pirate_door_guard")
