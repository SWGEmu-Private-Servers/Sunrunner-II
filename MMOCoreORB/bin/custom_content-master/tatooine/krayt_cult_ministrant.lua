krayt_cult_ministrant = Creature:new {
	customName = "a krayt cult ministrant",
	...
	lootGroups = {
		{
			groups = {
				...
				{group = "g_pinpoint_necklace", chance = 500000},
				{group = "g_pinpoint_ring", chance = 500000},
...
CreatureTemplates:addCreatureTemplate(krayt_cult_ministrant, "krayt_cult_ministrant")
