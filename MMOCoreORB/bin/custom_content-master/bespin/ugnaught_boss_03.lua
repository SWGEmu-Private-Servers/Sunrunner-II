ugnaught_boss_03 = Creature:new {
	customName = "a disgruntled Ugnaught manager",
	...
	lootGroups = {	
		{
			groups = {
				...
				{group = "g_bespin_shelves", chance = 100000},
...
CreatureTemplates:addCreatureTemplate(ugnaught_boss_03, "ugnaught_boss_03")
