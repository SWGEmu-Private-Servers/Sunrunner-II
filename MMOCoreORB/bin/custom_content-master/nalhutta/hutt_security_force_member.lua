hutt_security_force_member = Creature:new {
	customName = "a Hutt Security Force guard",
...
CreatureTemplates:addCreatureTemplate(hutt_security_force_member, "hutt_security_force_member")
